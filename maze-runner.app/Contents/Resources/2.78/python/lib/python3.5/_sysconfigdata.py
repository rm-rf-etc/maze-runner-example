...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/tmp/Python-3.5/blender/bin',
 'BINLIBDEST': '/tmp/Python-3.5/blender/lib/python3.5',
 ...
 'CONFIGURE_LDFLAGS': '-arch i386 -arch x86_64 -isysroot '
                      '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk',
 'CONFIG_ARGS': "'--prefix=/tmp/Python-3.5/blender' 'CC=clang' "
                "'CXX=CC=clang++' '--enable-ipv6' "
                "'--enable-universalsdk=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk' "
                "'--with-universal-archs=intel' "
                "'MACOSX_DEPLOYMENT_TARGET=10.6'",
 'CONFINCLUDEDIR': '/tmp/Python-3.5/blender/include',
 'CONFINCLUDEPY': '/tmp/Python-3.5/blender/include/python3.5m',
 'COREPYTHONPATH': ':plat-darwin',
 'COVERAGE_INFO': '/Users/mberger/src/python/Python-3.5.0/coverage.info',
 'COVERAGE_REPORT': '/Users/mberger/src/python/Python-3.5.0/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -IInclude -I./Include -isysroot '
             '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk',
 'CXX': 'CC=clang++',
 'DESTDIRS': '/tmp/Python-3.5/blender /tmp/Python-3.5/blender/lib '
             '/tmp/Python-3.5/blender/lib/python3.5 '
             '/tmp/Python-3.5/blender/lib/python3.5/lib-dynload',
 'DESTLIB': '/tmp/Python-3.5/blender/lib/python3.5',
 'DESTPATH': '',
 'DESTSHARED': '/tmp/Python-3.5/blender/lib/python3.5/lib-dynload',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/tmp/Python-3.5/blender/include '
                   '/tmp/Python-3.5/blender/include '
                   '/tmp/Python-3.5/blender/include/python3.5m '
                   '/tmp/Python-3.5/blender/include/python3.5m',
 'INCLUDEDIR': '/tmp/Python-3.5/blender/include',
 'INCLUDEPY': '/tmp/Python-3.5/blender/include/python3.5m',
 ...
 'LDVERSION': '3.5m',
 'LIBC': '',
 'LIBDEST': '/tmp/Python-3.5/blender/lib/python3.5',
 'LIBDIR': '/tmp/Python-3.5/blender/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/tmp/Python-3.5/blender/lib/pkgconfig',
 'LIBPL': '/tmp/Python-3.5/blender/lib/python3.5/config-3.5m',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/tmp/Python-3.5/blender/lib/python3.5',
 'MACOSX_DEPLOYMENT_TARGET': '10.6',
 'MAINCC': 'clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/tmp/Python-3.5/blender/share/man',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk  '
                   '-DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -IInclude -I./Include -isysroot '
                '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/tmp/Python-3.5/blender/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TM_IN_SYS_TIME': 0,
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk',
 ...
 'abs_builddir': '/Users/mberger/src/python/Python-3.5.0',
 'abs_srcdir': '/Users/mberger/src/python/Python-3.5.0',
 'datarootdir': '/tmp/Python-3.5/blender/share',
 'exec_prefix': '/tmp/Python-3.5/blender',
 'prefix': '/tmp/Python-3.5/blender',
 'srcdir': '.'}
